!(function(global, factory) {
        ...
        void 0 !==
          (_window =
            void 0 !== hostWindow
              ...
              ? self
              : global).document && _window.document.attachEvent;
    if (!attachEvent) {
      var requestFrame =
          ((raf =
  ...
  var AutoSizer = (function() {
    ...
    return (
      _inherits(AutoSizer, React.PureComponent),
    ...
    function CellMeasurerCache() {
      ...
      (this._hasFixedHeight = !0 === fixedHeight),
        ...
        (this._defaultHeight = Math.max(
          this._minHeight,
          'number' == typeof defaultHeight ? defaultHeight : 30,
        )),
        (this._defaultWidth = Math.max(
          this._minWidth,
          'number' == typeof defaultWidth ? defaultWidth : 100,
        )),
          ...
          _defineProperty(_assertThisInitialized(_this), '_onScroll', function(
            ...
            if (event.target === _this._scrollingContainer) {
              ...
              var _this$props3 = _this.props,
                ...
                _cellLayoutManager$ge = cellLayoutManager.getTotalSize(),
              ...
              if (
                ...
                var scrollPositionChangeReason = event.cancelable
                  ? SCROLL_POSITION_CHANGE_REASONS_OBSERVED
  ...
  var Section = (function() {
    ...
    SectionManager = (function() {
      function SectionManager() {
        var sectionSize =
          0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : 100;
  ...
  var cancelAnimationTimeout = function(frame) {
    ...
    requestAnimationTimeout = function(callback, delay) {
      ...
      var frame = {
        id: window.requestAnimationFrame(function timeout() {
                ...
                return (
                  'number' == typeof scrollLeft &&
                    ...
                    ((newState.scrollDirectionHorizontal =
                      scrollLeft > prevState.scrollLeft ? 1 : -1),
                    (newState.scrollLeft = scrollLeft)),
                  'number' == typeof scrollTop &&
                    0 <= scrollTop &&
                    ((newState.scrollDirectionVertical =
                      scrollTop > prevState.scrollTop ? 1 : -1),
  ...
  (proto.intervals = function(result) {
    ...
    (proto.insert = function(interval) {
      ...
      if (((this.count += 1), interval[1] < this.mid))
        this.left
      ...
      function PositionCache() {
        _classCallCheck(this, PositionCache),
          ...
          _defineProperty(
            ...
            '_intervalTree',
            (function(intervals) {
              return intervals && 0 !== intervals.length
          ...
          _defineProperty(
            ...
            function(_ref5) {
              ...
              if (
                ...
                'function' == typeof onScrollbarPresenceChange &&
                  onScrollbarPresenceChange({
