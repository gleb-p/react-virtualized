      ...
      (0, _createClass2['default'])(CellMeasurer, [
        ...
        },
        {
          ...
          value: function _getCellMeasurements() {
            ...
            var node = (0, _reactDom.findDOMNode)(this); // TODO Check for a bad combination of fixedWidth and missing numeric width or vice versa with height
      ...
      : {
          cache: function cache() {
            return (typeof require('./types')
              .bpfrpt_proptype_CellMeasureCache === 'function'
              ? require('./types').bpfrpt_proptype_CellMeasureCache.isRequired
                ? require('./types').bpfrpt_proptype_CellMeasureCache.isRequired
                : require('./types').bpfrpt_proptype_CellMeasureCache
