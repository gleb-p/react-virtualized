...
var _calculateSizeAndPositionDataAndUpdateScrollOffset = _interopRequireDefault(
  require('./utils/calculateSizeAndPositionDataAndUpdateScrollOffset'),
);
...
var _createCallbackMemoizer = _interopRequireDefault(
  require('../utils/createCallbackMemoizer'),
);
...
var _updateScrollIndexHelper = _interopRequireDefault(
  require('./utils/updateScrollIndexHelper'),
);

var _defaultCellRangeRenderer = _interopRequireDefault(
  require('./defaultCellRangeRenderer'),
);
    ...
    (function(_React$PureComponent) {
      ...
      function Grid(props) {
        ...
        _this = (0, _possibleConstructorReturn2['default'])(
          this,
          (0, _getPrototypeOf2['default'])(Grid).call(this, props),
        );
        (0, _defineProperty2['default'])(
          (0, _assertThisInitialized2['default'])(_this),
          '_onGridRenderedMemoizer',
          (0, _createCallbackMemoizer['default'])(),
        );
        (0, _defineProperty2['default'])(
          (0, _assertThisInitialized2['default'])(_this),
          '_onScrollMemoizer',
          (0, _createCallbackMemoizer['default'])(false),
        );
        (0, _defineProperty2['default'])(
          (0, _assertThisInitialized2['default'])(_this),
        ...
        var columnSizeAndPositionManager = new _ScalingCellSizeAndPositionManager[
          'default'
        ]({
        ...
        var rowSizeAndPositionManager = new _ScalingCellSizeAndPositionManager[
          'default'
        ]({
          ...
          },
          {
            ...
            value: function handleScrollEvent(_ref2) {
              var _ref2$scrollLeft = _ref2.scrollLeft,
                ...
                scrollTopParam =
                  _ref2$scrollTop === void 0 ? 0 : _ref2$scrollTop;
          ...
          },
          {
            ...
            value: function recomputeGridSize() {
              var _ref4 =
                ...
                columnIndex =
                  _ref4$columnIndex === void 0 ? 0 : _ref4$columnIndex,
        ...
        [
          {
            ...
            value: function getDerivedStateFromProps(nextProps, prevState) {
              ...
              var maybeStateB;
              (0,
              _calculateSizeAndPositionDataAndUpdateScrollOffset['default'])({
    ...
    process.env.NODE_ENV === 'production'
      ...
      : {
          ...
          cellRenderer: function cellRenderer() {
            return (typeof require('./types').bpfrpt_proptype_CellRenderer ===
            'function'
              ? require('./types').bpfrpt_proptype_CellRenderer.isRequired
                ? require('./types').bpfrpt_proptype_CellRenderer.isRequired
                : require('./types').bpfrpt_proptype_CellRenderer
          ...
          cellRangeRenderer: function cellRangeRenderer() {
            return (typeof require('./types')
              .bpfrpt_proptype_CellRangeRenderer === 'function'
              ? require('./types').bpfrpt_proptype_CellRangeRenderer.isRequired
                ? require('./types').bpfrpt_proptype_CellRangeRenderer
                    .isRequired
                : require('./types').bpfrpt_proptype_CellRangeRenderer
              : require('prop-types').shape(
                  require('./types').bpfrpt_proptype_CellRangeRenderer,
          ...
          columnWidth: function columnWidth() {
            return (typeof require('./types').bpfrpt_proptype_CellSize ===
            'function'
              ? require('./types').bpfrpt_proptype_CellSize.isRequired
                ? require('./types').bpfrpt_proptype_CellSize.isRequired
                : require('./types').bpfrpt_proptype_CellSize
              : require('prop-types').shape(
                  require('./types').bpfrpt_proptype_CellSize,
                ).isRequired
            ).apply(this, arguments);
          ...
          noContentRenderer: function noContentRenderer() {
            return (typeof require('./types')
              ...
              ? require('./types').bpfrpt_proptype_NoContentRenderer.isRequired
                ? require('./types').bpfrpt_proptype_NoContentRenderer
                    .isRequired
                : require('./types').bpfrpt_proptype_NoContentRenderer
              : require('prop-types').shape(
                  require('./types').bpfrpt_proptype_NoContentRenderer,
          ...
          overscanIndicesGetter: function overscanIndicesGetter() {
            return (typeof require('./types')
              ...
              ? require('./types').bpfrpt_proptype_OverscanIndicesGetter
                  .isRequired
                ? require('./types').bpfrpt_proptype_OverscanIndicesGetter
                    .isRequired
                : require('./types').bpfrpt_proptype_OverscanIndicesGetter
          ...
          scrollToAlignment: function scrollToAlignment() {
            return (typeof require('./types').bpfrpt_proptype_Alignment ===
            'function'
              ? require('./types').bpfrpt_proptype_Alignment.isRequired
                ? require('./types').bpfrpt_proptype_Alignment.isRequired
                : require('./types').bpfrpt_proptype_Alignment
              : require('prop-types').shape(
                  require('./types').bpfrpt_proptype_Alignment,
                ).isRequired
            ).apply(this, arguments);
