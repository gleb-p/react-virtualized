...
var _ScalingCellSizeAndPositionManager = _interopRequireDefault(
  require('./ScalingCellSizeAndPositionManager.js'),
);
...
function updateScrollIndexHelper(_ref) {
  ...
  var sizeHasChanged =
    ...
    !previousCellSize ||
    (typeof cellSize === 'number' && cellSize !== previousCellSize); // If we have a new scroll target OR if height/row-height has changed,
